...
use Elightwalk\Modules\Exceptions\InvalidAssetPath;
use Elightwalk\Modules\Exceptions\ModuleNotFoundException;
use Elightwalk\Modules\Process\Installer;
use Elightwalk\Modules\Process\Updater;
use Elightwalk\Modules\Activators\FileActivator;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \Elightwalk\Modules\Module
     */
    ...
    public function getOrdered($direction = 'asc') : array
    {
        ...
        $moduleStatusFile=$fileActivator->getModulesStatuses();

        if(count($modules) && count($moduleStatusFile)) {
            foreach($moduleStatusFile as $key => $value) {
                if(isset($modules[$key])) {
                    $sequenceModules[$key]=$modules[$key];
                }
            }
        }
        //krsort($modules);
     ...
     * @return string
     * @throws \Elightwalk\Modules\Exceptions\ModuleNotFoundException
     */
