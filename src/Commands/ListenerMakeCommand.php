...
use Elightwalk\Modules\Support\Config\GenerateConfigReader;
use Elightwalk\Modules\Support\Stub;
use Elightwalk\Modules\Traits\ModuleCommandTrait;
...
class ListenerMakeCommand extends GeneratorCommand
{
    ...
    protected function getEventName(Module $module)
    {
        ...
        $modulePath=str_replace('\Listeners', '', $this->getClassNamespace($module));

        return $modulePath . "\\" . $eventPath->getPath() . "\\" . $this->option('event');
    }
